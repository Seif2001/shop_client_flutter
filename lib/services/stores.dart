...
class StoreService {
  ...
  static Future<bool> addProduct(String name, String price, File image, String storeId) async {
    final Uri uri = Uri.parse(baseUrl + "products/$storeId");
    ...
    if (image != null) {
      ...
      final imageMultipartFile = http.MultipartFile(
        ...
        contentType: MediaType('image', 'jpeg'), // Set the content type based on the image type
      );
